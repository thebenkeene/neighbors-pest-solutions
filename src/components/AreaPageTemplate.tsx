            ...
            <div>
              ...
              <div className="space-y-3">
                {data.commonPests.map((pest, i) => (
                  <div key={i} className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-primary-50 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
