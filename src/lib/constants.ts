export const BUSINESS = {
  ...
  geo: {
    // Verified office coordinates (9030 Kenamar Dr #301) — feeds both the
    // geo meta tags and LocalBusiness JSON-LD.
    latitude: 32.8867087,
    longitude: -117.1570582,
  },
...
export const SERVICES = [
  { name: "Ant Control", slug: "ant-control", icon: "/images/icons/ant.png" },
  { name: "Bed Bug Control", slug: "bed-bug-control", icon: "/images/icons/bed-bug.png" },
  { name: "Spider Control", slug: "spider-control", icon: "/images/icons/spider.png" },
  { name: "Rodent Control", slug: "rodent-control", icon: "/images/icons/rodent.png" },
  { name: "Cockroach Control", slug: "cockroach-control", icon: "/images/icons/cockroach.png" },
  { name: "Mosquito Control", slug: "mosquito-control", icon: "/images/icons/mosquito.png" },
  { name: "Flea Control", slug: "flea-control", icon: "/images/icons/flea.png" },
  { name: "Tick Control", slug: "tick-control", icon: "/images/icons/tick.png" },
  { name: "Carpenter Ant Control", slug: "carpenter-ant-control", icon: "/images/icons/carpenter-ant.png" },
  { name: "Stinging Pest Control", slug: "stinging-pest-control", icon: "/images/icons/stinging-pest.png" },
  { name: "Fly Control", slug: "fly-control", icon: "/images/icons/fly.png" },
  { name: "Earwig Control", slug: "earwig-control", icon: "/images/icons/earwig.png" },
  { name: "Cricket Control", slug: "cricket-control", icon: "/images/icons/cricket.png" },
  { name: "Silverfish Control", slug: "silverfish-control", icon: "/images/icons/silverfish.png" },
  { name: "Centipede & Millipede Control", slug: "centipede-millipede-control", icon: "/images/icons/centipede.png" },
